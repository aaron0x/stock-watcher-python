...
class WatcherTestCase(unittest.TestCase):
    def test_has_notification(self):
        ...
        watch_config_parser = Mock(watch_conditions = [wc1, wc2], smtp_setting = expected_smtp_setting, to_addrs = expected_to_adds, query_timeout = 3)
    ...
    def test_no_notification(self):
        smtp_setting = SMTPSetting('smtp.gmail.com:587', 'aaron', 'TWRocks', 'aaron@gmai.com', 'subject')
